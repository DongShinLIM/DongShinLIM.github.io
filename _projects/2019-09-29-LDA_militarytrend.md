...
#### 본 연구에서 추출된 7개의 토픽들이 그 성격의 유사성에 따라 크게 3개 군집을 이루고 있는 모습을 볼 수 있다. 국가별로 군사 보안에 대해 어떤 법규와 제도가 마련되어 있는지 분석하는 토픽 ①(국가별 비교)ㆍ③(법규ㆍ제도) 가 서로 근접거리에 위치하고 있으며, 보안 위협에 대하여 어떠한 체계를 운용하여 대처를 하는지 분석하는 토픽 ②(보안 위협)ㆍ④(위협 대응)ㆍ⑥(체계 운용) 또한 서로 가까운 거리를 유지하고 있다.
